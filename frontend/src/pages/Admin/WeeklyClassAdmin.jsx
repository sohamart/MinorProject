                ...
                <div className='flex justify-between w-full'>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className='bg-blue-600/20 backdrop-blur-md border border-blue-400/50 text-blue-300 px-4 py-2 rounded-xl hover:bg-blue-500/30 transition'
                    >
                      Edit
                    </button>
                    ...
                    <button
                      ...
                      className='bg-red-600/20 backdrop-blur-md border border-red-400/40 text-red-300 px-4 py-2 rounded-xl hover:bg-red-500/30 transition'
                    >
