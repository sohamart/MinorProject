...
const AdminLogin = () => {
    ...
    return (
        <>
            <form
                onSubmit={formhandel}
                className={`bg-red-400 relative lg:w-100 lg:p-5 w-80 md:w-180 p-5 md:p-15 rounded-2xl shadow-lg flex flex-col items-center justify-center`}>
                ...
                >
                    {loading ? <h1 className='text-sm md:text-xl lg:text-xl'>loading...</h1> : "Login"} {/* 🔥 */}
                </button>
