...
const loading = () => {
  ...
  return (
    <div className='transform z-12 transition ease-in duration-300 flex-col h-screen w-screen flex bg-black/15 backdrop-blur-2xl  items-center justify-center '>
